...
D_0 = 6.0*10**-5 #initial diameter of droplet
...
X_AWAY = 2 #a distance 2 meters away from source 
...
def exposure_per_breath(time,temp,initial_D): 
    ...
    for i in range(1,501,1):
      tm = (i)/(100.0)
      conc = concentration(tm,temp,initial_D)
...
def total_exposure(time=5,temp=TEMPERATURE,initial_D=D_0):
    ...
    ''' 
    exposure_p_breath = exposure_per_breath(time,temp,initial_D)
